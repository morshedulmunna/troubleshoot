...
function CodePanelHeader({ tag, label }: { tag: any; label: any }) {
	if (!tag && !label) {
		return null;
	}
...
function usePreventLayoutShift() {
	let positionRef = useRef<any>();
	let rafRef = useRef<any>();
...
const usePreferredLanguageStore = create<PreferredLanguageState>((set) => ({
	preferredLanguages: [],
...
function useTabGroupProps(availableLanguages: any) {
