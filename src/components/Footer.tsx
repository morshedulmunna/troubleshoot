...
// import { discord, github, twitter, navigations } from "@/lib/const";
...
// function FeedbackButton(props: any) {
// 	return (
// 		<button
// 			type="submit"
...
// 		>
// 			<div className="flex items-center gap-3 rounded-full bg-primary-50/50 py-1 pr-3 pl-1.5 text-sm text-primary-900 ring-1 ring-inset ring-primary-500/20 dark:bg-primary-500/5 dark:text-primary-200 dark:ring-primary-500/30">
...
// 	let allPages = navigations.flatMap((group) => group.links);
// 	let currentPageIndex = allPages.findIndex(
// 		(page: any) => page?.href === pathname
// 	);
...
// 			<Icon className="h-5 w-5 fill-zinc-700 dark:fill-slate-300 transition group-hover:fill-zinc-900 dark:group-hover:fill-white" />
// 		</Link>
// 	);
// }
...
// 					Follow us on GitHub
// 				</SocialLink>
// 				<SocialLink href={discord} icon={DiscordIcon}>
...
// 			<div
// 				className={cn(
// 					"mx-auto px-4 transition sm:px-6 lg:px-8",
        ...
        >
          {siteConfig.footerNav.map((item) => (
            <div key={item.title} className="space-y-3">
              <h4 className=" font-bold text-lg text-[#F2BA11]">{item.title}</h4>
