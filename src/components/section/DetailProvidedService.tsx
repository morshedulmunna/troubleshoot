...
import { Settings, MapPin, ArrowRight, User2, MessagesSquare, Smartphone } from "lucide-react";
...
const Service = () => {
  return (
    <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      <Image width={100} height={100} className="rounded-t-lg w-full m-0 p-0" src={DemoBooking} alt="" />

      <div className="">
        <div className="flex-1 min-w-0 p-5 ">
          <h6 className="text-lg color-black font-medium  leading-6">Data Recovery and backup solutations</h6>
          ...
          <h6 className="text-2xl text-primary-500 font-medium mt-2">৳3,500/Service</h6>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="rounded-lg shadow p-5 mt-5">
      <div className="flex items-center ">
        <Button className="font-semibold bg-primary-500/90 hover:bg-primary-500 text-white rounded p-2" variant="filled">
          <User2 size={15} />
        </Button>
      ...
      <div className="flex justify-between rounded-lg shadow-lg items-center p-2 mt-5 mb-5">
        ...
        <div className="flex gap-2">
          <Button className="font-semibold bg-primary-50 hover:bg-primary-100 text-black rounded p-3" variant="filled">
            <Smartphone size={10} />
          </Button>
          <Button className="font-semibold bg-primary-50 hover:bg-primary-100 text-black rounded p-3" variant="filled">
...
const Hint = () => {
  return (
    <div className="rounded-lg shadow py-7 px-5 mt-5">
      <div className="flex gap-4">
        <Button className="font-semibold bg-primary-500/90 hover:bg-primary-500 text-white rounded px-10 py-2" variant="filled">
          Accept
        </Button>
        <Button className="font-semibold bg-slate-100 hover:bg-primary-500 text-white rounded px-10 py-2 text-black" variant="filled">
          Accepted
        </Button>
      </div>
      <div className="py-10">
        ...
        <p>
          Troubleshoot is a start-up organization offering residents of Bangladesh a complete IT corporate service. By developing the
          reputation as a qualified, reasonably priced and trusted service provider, troubleshoot quickly generated market penetration and
          develop a solid foundation of repeat customers. We are here to make your corporate life run smoothly! We work on demand subject to
          availability, nevertheless arrive on time, and are available for a same day call-outs wherever possible. Our multi-skilled
          troubleshooters work alone unless otherwise requested by customers.
        </p>
      </div>
    </div>
  );
