...
// const publicIndexName = process.env.NEXT_PUBLIC_DOCSEARCH_INDEX_NAME ?? "";
...
// function resolveResult(result: any) {
// 	let allLevels = Object.keys(result.hierarchy);
// 	let hierarchy: [any, { value: any }][] = Object.entries(
// 		result._highlightResult.hierarchy
// 	);
// 	if (hierarchy) {
// 		hierarchy = hierarchy.filter(([, { value }]) => Boolean(value));
// 	}
...
// 				>
// 					{hierarchyHtml?.map(
// 						(item: any, itemIndex: any, items: any) => (
...
// 			{collection.items.map((result: any, resultIndex: any) => (
// 				<SearchResult
// 					key={result.objectID}
// 					result={result}
...
// function AlgoliaLogo(props: any) {
// 	return (
...
// 		autocomplete,
// 		autocompleteState,
// 	}: { autocomplete: any; autocompleteState: any } = useAutocomplete();
